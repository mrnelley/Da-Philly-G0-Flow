$(document).ready(function() {
        ...
        for (var i = 0; i < events.length; i++) {
          if (events[i].show != null) {
            ...
            if (repeatType == 1) {
              ...
              if (state == "past") {
                console.log('found current show');
                foundCurrentShow = true;
                if (!currentShowID || events[i].show != currentShowID) {
                  console.log('getting current show info');
  ...
  rjq('#rjp-currentshow').off('rj-track-load-event');
  rjq('#rjp-currentshow').on('rj-track-load-event', function(event, data) {
    console.log(data);
    updateInfo(data);

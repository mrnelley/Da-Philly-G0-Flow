$(document).ready(function() {
  ...
  $(document).on("trackChange", function(eventData){
    ...
    var song = $('#trackInfo')
    console.log(song[0].innerHTML.replace(/"/g, "").split('-'));
    ...
    if(album == 'Unknown'){
      ...
      var currentTrack = $.get({
        url:`https://ws.audioscrobbler.com/2.0/?method=album.getinfo&api_key=72fb26b4a15ccc71233b61d94cc275bf&artist=${encodeURIComponent(artist.trim())}&track=${song.innerHTML}`,
